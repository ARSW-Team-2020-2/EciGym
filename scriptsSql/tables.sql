...
CREATE TABLE IF NOT EXISTS Usuario(id SERIAL, document VARCHAR(50) NOT NULL, documenttype VARCHAR(20) NOT NULL, name VARCHAR(50) NOT NULL, phone VARCHAR(50) NOT NULL, email VARCHAR(50) PRIMARY KEY, password VARCHAR(20) NOT NULL, subasta BIGINT NOT NULL);

CREATE TABLE IF NOT EXISTS Subasta (id SERIAL PRIMARY KEY, initdate TIMESTAMP, findate TIMESTAMP NOT NULL, usuario VARCHAR(50) REFERENCES Usuario(email));
...
CREATE TABLE IF NOT EXISTS Puja(id SERIAL PRIMARY KEY, usuario VARCHAR(50) REFERENCES Usuario(email), fecha TIMESTAMP , amount BIGINT NOT NULL, subasta BIGINT REFERENCES Subasta(id));
